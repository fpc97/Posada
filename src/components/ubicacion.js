...
class Ubicacion extends React.Component {
    ...
    render() {
        const generarDestinos = () => this.state.destinos.map((dest, ind) => <li><a className={ubicacionStyle.listaLink} onClick={() => this.manageDestClick(ind)} href='javascript:void(0)'>{dest[0]} <span>{dest[1]}</span></a></li>);

        return (
            <div className={`container-general ${ubicacionStyle.container}`}>
                <div className={ubicacionStyle.introContainer}>
                    <div className={`titulo-wrap container-parrafo c-izq`}>
                        <h2>Ubicación</h2>
                    ...
                    <p className={`container-parrafo c-izq`}>Nuestra <strong>Posada B&B</strong> se encuentra a <a href='javascript:void(0)'>200 metros del Casco Histórico</a>, hoy Patrimonio de la Humanidad.</p>
                </div>
                ...
                <div className={`${ubicacionStyle.listaContainer}`}>
                    <p className={`container-parrafo c-izq`}>Otros sitios de interés son:</p>
                    <ul className={`container-imagen ${ubicacionStyle.listaUl}`}>
                        {generarDestinos()}
                        {generarDestinos()}
                        {generarDestinos()}
                        {/*
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Centro Comercial <span>200 metros</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Restaurantes y Pizzerías <span>200 metros</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Arroyo Chicamtoltina <span>200 metros</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Terminal de Omnibus <span>600 metros</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Casa en donde falleció el escritor Belisario Roldán <span>150 metros</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Casa en donde vivió el “Che” Guevara <span>10 cuadras</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Golf Club de Alta Gracia <span>10 cuadras</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Centro Comercial <span>200 metros</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Restaurantes y Pizzerías <span>200 metros</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Arroyo Chicamtoltina <span>200 metros</span></a></li>
                        <li><a className={ubicacionStyle.listaLink} href='javascript:void(0)'>Terminal de Omnibus <span>600 metros</span></a></li>
