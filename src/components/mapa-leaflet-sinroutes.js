...
class MapLeaflet extends React.Component {
    ...
    establecerRuta(num) {
        ...
        const iconoInvisible = this.state.L.icon({
        ...
        const iconoDestino = this.state.L.icon({
        ...
        const ruta = this.state.L.Routing.control({
            waypoints: [
                this.state.L.latLng(-31.6576608, -64.4395798),
                this.state.L.latLng(num[0], num[1])
            ],
            lineOptions: {
                styles: [
                    {
            ...
            createMarker: function (i, start, n) {
                ...
                var marker = this.state.L.marker (start.latLng, {
                    icon: marker_icon
                });
                return marker
            }
    ...
    render() {
        if (typeof window !== 'undefined') {
            if (this.state.L === null){
                this.setState({
                    L: require('leaflet'),
                    rm: require('leaflet-routing-machine')
                })
                return (
                    <div>
                        hola
                ...
                const iconoCasa = this.state.L.icon({
                    iconUrl: require('../img/marcador-posada.png'),
                    shadowUrl: require('../img/marcador-posada-sombra.png'),
